...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A new job application has been submitted by {applicantName} for the position of {jobTitle}..create': {
    roles: ['owner', 'hr-manager'],
    key: 'job_application_submitted',
    tenantPath: [],
    userPath: [],
  },
  'A new job position {jobTitle} has been created by {hrManagerName}..create': {
    roles: ['owner', 'administrator'],
    key: 'job_position_created',
    tenantPath: [],
    userPath: [],
  },
  'A leave request has been submitted by {employeeName} for the dates {leaveDates}..create': {
    roles: ['owner', 'hr-manager'],
...
const tenantRoles: string[] = ['owner', 'hr-manager', 'employee', 'administrator', 'applicant'];
